...
if(isset($_SESSION['lastUserId'])){
    echo '<li><a class="nav-link" href="personal.html">'.$_SESSION["login"].'</a></li>';
    ...
    echo '<div><a class="nav-link exit-button" href="index.html" onclick="ExitButtonClick()"><img src="images/exit.png"></a></div>';
